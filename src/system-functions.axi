...
define_function resetAllDraggablePopups (dev dragAndDropVirtual)
{
    select
    {
		active (dragAndDropVirtual == vdvDragAndDropTpTable):
		{
			...
			hideDraggablePopup (vdvDragAndDropTpTable, dvDvxVidInSignage.port)
			...
			showDraggablePopup (vdvDragAndDropTpTable, dvDvxVidInSignage.port)
...
define_function addDragItemsAll (dev dragAndDropVirtual)
{
	...
	active (dragAndDropVirtual == vdvDragAndDropTpTable):
	{
	    ...
	    addDragItem (vdvDragAndDropTpTable, dvDvxVidInSignage.port)
...
define_function enableDragItemsAll (dev dragAndDropVirtual)
{
	select
	{
		active (dragAndDropVirtual == vdvDragAndDropTpTable):
		{
			...
			enableDragItem (vdvDragAndDropTpTable, dvDvxVidInSignage.port)
...
define_function disableDragItemsAll (dev dragAndDropVirtual)
{
	select
	{
		active (dragAndDropVirtual == vdvDragAndDropTpTable):
		{
			...
			disableDragItem (vdvDragAndDropTpTable, dvDvxVidInSignage.port)
...
define_function shutdownAvSystem ()
{
	...
	WAIT waitTimeRelayTravel 'RELAY TRAVELLING UP'
...
define_function tableInputDetected (dev dvTxVidIn)
{
	...
	if (!isSystemAvInUse)
	{
		...
		amxRelayPulse (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_DOWN)
		
		CANCEL_WAIT 'RELAY TRAVELLING UP'
		amxRelayOn (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_DOWN)
		WAIT waitTimeRelayTravel 'RELAY TRAVELLING DOWN'
		...
		showDraggablePopupsAll (vdvDragAndDropTpTable)
