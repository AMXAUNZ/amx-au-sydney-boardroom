...
/*button_event[dvKeypad1,0]
{
	push:
	{
		switch (button.input.channel)
		{
			...
			case BTN_KP_WHITEBOARD:  snapiLightingToggle (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_WHITEBOARD)
...
button_event[dvTpTableVideo,0]
{
	push:
	{
		switch (button.input.channel)
		{
			case BTN_VIDEO_MONITOR_LEFT_OFF:     snapiDisplayDisablePower (vdvMonitorLeft)
			case BTN_VIDEO_MONITOR_LEFT_ON:      snapiDisplayEnablePower (vdvMonitorLeft)
			case BTN_VIDEO_MONITOR_RIGHT_OFF:    snapiDisplayDisablePower (vdvMonitorRight)
			case BTN_VIDEO_MONITOR_RIGHT_ON:     snapiDisplayEnablePower (vdvMonitorRight)
...
button_event[dvTpTableLighting,0]
{
	push:
	{
		// disable the preset buttons if user did any manual light adjustment
		switch (button.input.channel)
		{
			case BTN_LIGHTING_AREA_FRONT_UP:
			case BTN_LIGHTING_AREA_FRONT_DN:
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_UP:
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_DN:
			{
				min_to [button.input]
				total_off[dcLightingPresetBtns]
			}
		...
		switch (button.input.channel)
		{
			...
			//case BTN_LIGHTING_AREA_WHITEBOARD_OFF:       snapiLightingOff (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_WHITEBOARD)
			//case BTN_LIGHTING_AREA_WHITEBOARD_ON:        snapiLightingOn (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_WHITEBOARD)
			
			case BTN_LIGHTING_AREA_FRONT_UP:             snapiLightingEnableRampUp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_FRONT)
			case BTN_LIGHTING_AREA_FRONT_DN:             snapiLightingEnableRampDown (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_FRONT)
			
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_UP:     snapiLightingEnableRampUp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_REAR)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_DN:     snapiLightingEnableRampDown (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_REAR)
			
			//case BTN_LIGHTING_AREA_TABLE_UP:             snapiLightingEnableRampUp (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
			//case BTN_LIGHTING_AREA_TABLE_DN:             snapiLightingEnableRampDown (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
		}
	}
	release:
	{
		switch (button.input.channel)
		{
			case BTN_LIGHTING_AREA_FRONT_UP:             snapiLightingDisableRamp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_FRONT)
			case BTN_LIGHTING_AREA_FRONT_DN:             snapiLightingDisableRamp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_FRONT)
			
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_UP:     snapiLightingDisableRamp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_REAR)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_DN:     snapiLightingDisableRamp (vdvLighting, LIGHTING_ADDRESS_BOARD_ROOM_REAR)
			
			//case BTN_LIGHTING_AREA_TABLE_UP:             snapiLightingDisableRamp (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
			//case BTN_LIGHTING_AREA_TABLE_DN:             snapiLightingDisableRamp (vdvLighting, LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
		}
	}
}
...
button_event[dvTpTableBlinds,0]
{
	push:
	{
		...
		switch (button.input.channel)
		{
			case BTN_BLIND_1_UP:
			{
				CANCEL_WAIT 'RELAY TRAVELLING DOWN'
				CANCEL_WAIT 'RELAY TRAVELLING UP'
				amxRelayOn (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_UP)
			}
			
			case BTN_BLIND_1_DOWN:  
			{
				CANCEL_WAIT 'RELAY TRAVELLING DOWN'
				CANCEL_WAIT 'RELAY TRAVELLING UP'
				amxRelayOn (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_DOWN)
			}
	...
	release:
	{
		...
		switch (button.input.channel)
		{
			case BTN_BLIND_1_UP:
			{
				amxRelayOff (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_UP)
			}
			
			case BTN_BLIND_1_DOWN:  
			{
				amxRelayOff (dvRelaysDvx, REL_DVX_BLOCKOUTS_FOYER_WINDOW_DOWN)
			}
		}
	}
}
...
data_event[dvBluray]
{
	online:
	{
		// configure pulse on and off times (default 1/2 second pulse time is too long)
		amxIrSetOnTime (dvBluray,2)
		amxIrSetOffTime (dvBluray,5)
	}
}

button_event [dvTpTableBluray,0]
{
	push:
	{
		switch (button.input.channel)
		{
			case BTN_BLURAY_MENU:             amxIrStackPulse (dvBluray, IR_BLURAY_MENU)
			case BTN_BLURAY_SELECT:           amxIrStackPulse (dvBluray, IR_BLURAY_SELECT)
			case BTN_BLURAY_BACK:             amxIrStackPulse (dvBluray, IR_BLURAY_RETURN)
			case BTN_BLURAY_EXIT:             amxIrStackPulse (dvBluray, IR_BLURAY_EXIT)
			case BTN_BLURAY_UP:               amxIrStackPulse (dvBluray, IR_BLURAY_CURSOR_UP)
			case BTN_BLURAY_DOWN:             amxIrStackPulse (dvBluray, IR_BLURAY_CURSOR_DOWN)
			case BTN_BLURAY_LEFT:             amxIrStackPulse (dvBluray, IR_BLURAY_CURSOR_LEFT)
			case BTN_BLURAY_RIGHT:            amxIrStackPulse (dvBluray, IR_BLURAY_CURSOR_RIGHT)
			case BTN_BLURAY_STOP:             amxIrStackPulse (dvBluray, IR_BLURAY_STOP)
			case BTN_BLURAY_PLAY:             amxIrStackPulse (dvBluray, IR_BLURAY_PLAY)
			case BTN_BLURAY_PAUSE:            amxIrStackPulse (dvBluray, IR_BLURAY_PAUSE)
			case BTN_BLURAY_REWIND:           channelMinTo (dvBluray, IR_BLURAY_FAST_REVERSE)
			case BTN_BLURAY_FAST_FORWARD:     channelMinTo (dvBluray, IR_BLURAY_FAST_FORWARD)
			case BTN_BLURAY_CHAPTER_PREVIOUS: amxIrStackPulse (dvBluray, IR_BLURAY_CHAPTER_PREVIOUS)
			case BTN_BLURAY_CHAPTER_NEXT:     amxIrStackPulse (dvBluray, IR_BLURAY_CHAPTER_NEXT)
		}
	}
}
